---
name: Bug report
about: Create a bug report for ChirpStack Geolocation Server
---
...
- [ ] I have searched the [issues](https://github.com/brocaar/chirpstack-geolocation-server) of this repository and believe that this is not a duplicate.
...
<!--
  ...
  You can get this output running ChirpStack Geolocation Server from the cli.
  e.g. sudo chirpstack-geolocation-server
-->
```shell
